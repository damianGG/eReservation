	...
	<div class="container-fluid text-center">
		<div class="row content">
			<div class="col-sm-2 sidenav">
				<p>
					<a href="${pageContext.servletContext.contextPath}/customer/add">Add
						new Customer</a>
				</p>
				<p>
					<a href="${pageContext.servletContext.contextPath}/customer/list">List
						of customers</a>
				</p>
				<p>
					<a href="${pageContext.servletContext.contextPath}/customer/edit">Edit
						customer</a>
				</p>
			</div>
			<div class="col-sm-8 text-left">
				...
				<form:form modelAttribute="customer" method="post">
					...
					<form:input path="phoneNumber" placeholder="Nr telefonu" />

					
					<form:input type="date" path="dataVisit"
						placeholder="Termin wizyty" />

					<form:select items="${employees}" path="employee"
